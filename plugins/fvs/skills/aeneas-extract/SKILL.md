...
## A. Skill Invocation
- This skill is invoked by mentioning `$fvs:aeneas-extract`.
- Treat all user text after `$fvs:aeneas-extract` as `{{FVS_ARGS}}`.
...
<execution_context>
@${CLAUDE_PLUGIN_ROOT}/fv-skills/workflows/aeneas-extract.md
@${CLAUDE_PLUGIN_ROOT}/fv-skills/references/extraction-safety-model.md
