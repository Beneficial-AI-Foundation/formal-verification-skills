...
Usage:
  .formalising/.kb-venv/bin/python ${CLAUDE_PLUGIN_ROOT}/scripts/fvs-kb-query.py ask "What is X?" --notebook <id>
  .formalising/.kb-venv/bin/python ${CLAUDE_PLUGIN_ROOT}/scripts/fvs-kb-query.py ask "What is X?" --notebook <id> --text
  .formalising/.kb-venv/bin/python ${CLAUDE_PLUGIN_ROOT}/scripts/fvs-kb-query.py ask "What is X?" --notebook <id> --source <id1> --source <id2>
  .formalising/.kb-venv/bin/python ${CLAUDE_PLUGIN_ROOT}/scripts/fvs-kb-query.py list
